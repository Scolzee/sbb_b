...
async def bot_start(event):
    ...
    custompic = gvarstatus("BOT_START_PIC") or "https://telegra.ph/file/6cbc627ab2ab84940a615.jpg"
    if chat.id != Config.OWNER_ID:
        ...
        buttons = [
            (
                Button.url("السورس", "https://t.me/Ch_frozen"),
                Button.url(
                    "المطور",
                    "https://t.me/Scolze_WA",
                ),
            )
        ]
    else:
        ...
        buttons = [
            ...
            [
                ...
                Button.inline("• المطور •", data="https://t.me/Scolze_WA"),
            ],
        ]
    try:
        if custompic:
...
اوامر فارات سورس فروزين  @Ch_frozen""",
        buttons=[
