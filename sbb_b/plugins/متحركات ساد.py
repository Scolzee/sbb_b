...
async def tmgif(event):
    ...
    if sad:
        sbb_b = f"**˛Frozen ، ٰ𝖦𝗂𝖿 𝖲ِ𝖺ٰ𝖣 . .**\n"
        sbb_b += f"✛━━━━━━━━━━━━━✛\n"
        sbb_b += f"**الـمتحـرڪـة الأولـى **"
        await event.client.send_file(event.chat_id, sad, caption=sbb_b, reply_to=lMl10l)
